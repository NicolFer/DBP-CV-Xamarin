...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"319a10ef-33f4-4e46-8f1a-e7d820624718\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [20 x i8] c"com.companyname.cv1\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 92, ; number_of_assemblies_in_apk
	...
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 8
...
@__DSOCacheEntry_name.5 = internal constant [16 x i8] c"libmonodroid.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 1
...
@bundled_assemblies = local_unnamed_addr global [92 x %struct.XamarinAndroidBundledAssembly] [
	; 0
